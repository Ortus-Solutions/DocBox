...
<body>
	...
	<!--
		Pre-rendered command content (generated by DocBox).
		Loaded as a script rather than fetch()'d so the docs work when opened
		directly from disk (file://) without triggering CORS errors.
	-->
